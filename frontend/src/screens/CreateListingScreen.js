...
import { CATEGORIES, LISTING_TYPES, COLORS } from '../utils/constants';
            ...
            <View style={styles.field}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.pills}>
                    {conditions.map(cond => (
                        ...
                        >
                            <Text style={[styles.pillText, condition === cond && styles.pillTextActive]}>
                                {cond}
                            </Text>
                        </TouchableOpacity>
                    ))}
            ...
            <View style={styles.field}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.pills}>
                    {LISTING_TYPES.filter(t => t !== 'All').map(type => (
                        ...
                        >
                            <Text style={[styles.pillText, listingType === type && styles.pillTextActive]}>
                                {type}
                            </Text>
                        </TouchableOpacity>
                    ))}
